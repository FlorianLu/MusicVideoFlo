...
class MusicVideoDetailVC: UIViewController {
    ...
    func touchIdChk() {
        ...
        let reasonString = "Touch-Id authentication is needed \n to share info on Social Media"
        
        // Check if we can access local device authentication
        if context.canEvaluatePolicy(LAPolicy.DeviceOwnerAuthenticationWithBiometrics, error: &touchIDError) {
            // Check what the autentication response was
            ...
            case .TouchIDNotAvailable:
                alert.message = "Touch ID is not available on the decice"
            case .PasscodeNotSet:
                alert.message = "Passcode has not been set"
            case .InvalidContext:
                alert.message = "The context is invalid"
            default:
                alert.message = "Loca Authentication not available"
            }
